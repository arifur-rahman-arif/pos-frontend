...
/**
 * Create shadow of a given color
 * @param {string} color
 * @returns {string[]}
 */
...
/**
 * Create custom shadow of a given color
 * @param {string} color
 * @returns {{secondary: string, success: string, z1: string, z20: string,
 * z12: string, error: string, z24: string,
 * z8: string, z16: string, primary: string, info: string}}
 */
