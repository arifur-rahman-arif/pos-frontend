...
import TableToolbar from '@/components/page-component/TableToolbar';
    ...
    return (
        <>
            ...
            >
                ...
                <Link href="/dashboard/product/category/create" passHref>
                    <Button
                        variant="contained"
                        size="medium"
                        sx={{
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <Link
                                                                href={`/dashboard/product/category/${index}`}
                                                                passHref
                                                            >
                                                                <Typography
                                                                    variant="subtitle2"
